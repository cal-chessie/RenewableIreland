...
const tyrone: CountyData = {
  ...
  domain: "renewableireland.ie/counties/tyrone",
  mainTown: "Omagh",
...
const antrim: CountyData = {
  ...
  domain: "renewableireland.ie/counties/antrim",
  mainTown: "Antrim",
...
const armagh: CountyData = {
  ...
  domain: "renewableireland.ie/counties/armagh",
  mainTown: "Armagh",
...
const down: CountyData = {
  ...
  domain: "renewableireland.ie/counties/down",
...
const fermanagh: CountyData = {
  ...
  domain: "renewableireland.ie/counties/fermanagh",
...
const londonderry: CountyData = {
  ...
  domain: "renewableireland.ie/counties/londonderry",
  mainTown: "Derry",
...
const carlow: CountyData = {
  ...
  domain: "renewableireland.ie/counties/carlow",
  mainTown: "Carlow",
...
const cavan: CountyData = {
  ...
  domain: "renewableireland.ie/counties/cavan",
  mainTown: "Cavan",
...
const clare: CountyData = {
  ...
  domain: "renewableireland.ie/counties/clare",
  mainTown: "Ennis",
...
const cork: CountyData = {
  ...
  domain: "renewableireland.ie/counties/cork",
  mainTown: "Cork",
...
const donegal: CountyData = {
  ...
  domain: "renewableireland.ie/counties/donegal",
...
const dublin: CountyData = {
  ...
  domain: "renewableireland.ie/counties/dublin",
  mainTown: "Dublin",
...
const galway: CountyData = {
  ...
  domain: "renewableireland.ie/counties/galway",
  mainTown: "Galway",
...
const kerry: CountyData = {
  ...
  domain: "renewableireland.ie/counties/kerry",
  mainTown: "Tralee",
...
const kildare: CountyData = {
  ...
  domain: "renewableireland.ie/counties/kildare",
  mainTown: "Naas",
...
const kilkenny: CountyData = {
  ...
  domain: "renewableireland.ie/counties/kilkenny",
  mainTown: "Kilkenny",
...
const laois: CountyData = {
  ...
  domain: "renewableireland.ie/counties/laois",
  mainTown: "Portlaoise",
...
const leitrim: CountyData = {
  ...
  domain: "renewableireland.ie/counties/leitrim",
...
const limerick: CountyData = {
  ...
  domain: "renewableireland.ie/counties/limerick",
  mainTown: "Limerick",
...
const longford: CountyData = {
  ...
  domain: "renewableireland.ie/counties/longford",
  mainTown: "Longford",
...
const louth: CountyData = {
  ...
  domain: "renewableireland.ie/counties/louth",
  mainTown: "Dundalk",
...
const mayo: CountyData = {
  ...
  domain: "renewableireland.ie/counties/mayo",
  mainTown: "Castlebar",
...
const meath: CountyData = {
  ...
  domain: "renewableireland.ie/counties/meath",
  mainTown: "Navan",
...
const monaghan: CountyData = {
  ...
  domain: "renewableireland.ie/counties/monaghan",
  mainTown: "Monaghan",
...
const offaly: CountyData = {
  ...
  domain: "renewableireland.ie/counties/offaly",
  mainTown: "Tullamore",
...
const roscommon: CountyData = {
  ...
  domain: "renewableireland.ie/counties/roscommon",
  mainTown: "Roscommon",
...
const sligo: CountyData = {
  ...
  domain: "renewableireland.ie/counties/sligo",
  mainTown: "Sligo",
...
const tipperary: CountyData = {
  ...
  domain: "renewableireland.ie/counties/tipperary",
  mainTown: "Clonmel",
...
const waterford: CountyData = {
  ...
  domain: "renewableireland.ie/counties/waterford",
  mainTown: "Waterford",
...
const westmeath: CountyData = {
  ...
  domain: "renewableireland.ie/counties/westmeath",
  mainTown: "Mullingar",
...
const wexford: CountyData = {
  ...
  domain: "renewableireland.ie/counties/wexford",
  mainTown: "Wexford",
...
const wicklow: CountyData = {
  ...
  domain: "renewableireland.ie/counties/wicklow",
  mainTown: "Wicklow",
