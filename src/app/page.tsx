...
export default function HomePage() {
  return (
    <>
      ...
      <link rel="preload" href="/v8-deferred.css?v=16" as="style" />
      <link rel="stylesheet" href="/v8-deferred.css?v=16" media="print" id="v8-deferred-link" suppressHydrationWarning />
      <script
      ...
      />
      <noscript>
        <link rel="stylesheet" href="/v8-styles.css?v=14" />
      </noscript>
      <a
        href="#get-started"
        style={{
