...
export default function HomePage() {
  return (
    <>
      ...
      <link rel="preload" href="/v8-deferred.css?v=13" as="style" />
      <link rel="stylesheet" href="/v8-deferred.css?v=13" media="print" id="v8-deferred-link" suppressHydrationWarning />
      <script
      ...
      />
      <noscript>
        <link rel="stylesheet" href="/v8-styles.css?v=13" />
      </noscript>
      <a
        href="#get-started"
        style={{
